  ...
  <div class="w-full lg:w-3/4  rounded overflow-hidden shadow-lg ">
    <div class="px-6 py-4 ">
      ...
      <p class="text-gray-800 m-1 p-1 text-base">
        <ul class="list-disc px-2">
          ...
          <li class="m-1 p-1">
            Started my career with php, mysql, javascript, jquery.
          </li>
        </ul>
      </p>
    </div>
        ...
        <ul class="list-disc px-2">
          <li class="m-1 p-1">
            <div class="flex">
              ...
              <span class="ml-auto font-bold text-l">April 2019 - Present</span>
            </div>
            <div>
              <a href="https://neev.io/" target="_blank" class="underline hover:bg-gray-200">Neev Labs</a>
            </div>
            <div>
              <p>
          ...
          <li class="m-1 p-1">
            ...
            <div>
              <a href="https://www.cepheisys.com/" target="_blank" class="underline hover:bg-gray-200">Cepheisys Solution (Raj Computers)</a>
            </div>
            <div>
              <p>
                Creating web applications, websites using core php, html, css, bootstrap, mysql, jquery, javascript.
              </p>
            </div>
          </li>
        </ul>
    ...
    <div class="px-6 py-4">
      ...
      <p class="text-gray-800 m-1 p-1 text-base">
        <ul class="list-disc px-2">
          <li class="m-1 p-1">
            <p>Email - <span class="underline">faisalshaikh8433@gmail.com</span></p>
          </li>
          <li class="m-1 p-1">
            <p>Phone - <span class="underline">+918433776085</span></p>
          </li>
        </ul>
      </p>
    </div>
